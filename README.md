...
* **Stable version (cuda 12)**
  ...
  ```sh
  # stable version (cuda 12)
  docker pull lmsysorg/sglang:v0.5.9-runtime
  ```
  
* <details> <summary> Nightly version (cuda 13) </summary>

  ```sh
  docker pull lmsysorg/sglang:v0.5.9-cu130-runtime
  docker build -t lmsysorg/sglang:v0.5.9-cu130-runtime-pd -f sgl/pd.dockerfile .
  ```
